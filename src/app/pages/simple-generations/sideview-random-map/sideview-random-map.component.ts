...
import SideRandomRender from 'src/app/generation/canvas-renderers/simple/random/SideRandomRender';
import Vec2 from 'src/app/maths/geometry/Vec2';

@Component({
  selector: 'app-sideview-random-map',
  templateUrl: './sideview-random-map.component.html',
  styleUrls: ['./sideview-random-map.component.scss']
})
export class SideviewRandomMapComponent {

  readonly renderer = new SideRandomRender(0.4, Color.BROWN, Color.SKYBLUE);
